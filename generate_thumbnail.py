...
SCENIC_STYLES = [
    "stunning Georgian woman in traditional dress, Tbilisi, Narikala fortress",
    "elegant Georgian woman in chokha, Batumi, Black Sea coast",
    "beautiful Georgian woman in traditional attire, Svaneti, Caucasus mountains",
    "Georgian woman at wine vineyard, Kakheti, golden hour",
    "gorgeous Georgian woman in modern style, Tbilisi sunset, bridge of peace",
    "beautiful Georgian woman, Mtskheta, Svetitskhoveli Cathedral, warm light",
    "Georgian woman in traditional dress, Gudauri ski resort, mountain view",
    "elegant Georgian woman, Uplistsikhe cave town, zen atmosphere",
]


def generate_scenic_image(category_english: str, category_georgian: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Georgian", category_english)
    if premade:
        return premade
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Georgian language learning video. "
                f"{style}. "
                ...
                f"At top: '120 GEORGIAN PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY GEORGIAN'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    lang_fonts = [str(Path(__file__).parent / "fonts" / "NotoSansGeorgian-Bold.ttf"),
    ...
    draw.text((960, 180), "120 GEORGIAN PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
