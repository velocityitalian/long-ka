...
def ensure_playlist(youtube, title="Velocity Georgian - Georgian Phrases", description="All Georgian phrases videos in one playlist. Learn Georgian with Velocity Georgian!"):
