"""
YouTube Upload Script for Velocity Georgian
"""
...
def ensure_playlist(youtube, title="Learn Georgian Phrases for Beginners | Velocity Georgian", description="All georgian phrases videos in one playlist. 🇬🇪 Learn Georgian with Velocity Georgian!"):
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Georgian with Velocity Georgian"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Georgian", "Georgian Phrases", "Georgian Language", "Velocity Georgian", "Georgian for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY GEORGIAN - YOUTUBE UPLOADER")
